...
chunk.blocks[offset_x, -60, offset_z] = block_id_1
chunk.blocks[offset_x, -62, offset_z] = block_id_2

# Set the block entities.
for block_entity, location in (
    (universal_block_entity_1, (0, -60, 0)),
    (universal_block_entity_2, (0, -62, 0)),
):
